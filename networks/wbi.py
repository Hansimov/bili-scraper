...
class ParamsWBISigner:
    ...
    def get_wbi_keys(self) -> tuple[str, str]:
        ...
        resp = requests.get(
            "https://api.bilibili.com/x/web-interface/nav", headers=self.headers
        )
    ...
    def sign_params_with_wbi(self, params: dict, img_key: str, sub_key: str):
        ...
        mixin_key = self.get_magic_key(img_key + sub_key)
    ...
    def run(self, params: dict):
        ...
        signed_params = self.sign_params_with_wbi(params, img_key, sub_key)
        return signed_params


if __name__ == "__main__":
    url = "https://api.bilibili.com/x/space/wbi/arc/search"
    params = {"mid": 946974, "pn": 2, "ps": 5}
